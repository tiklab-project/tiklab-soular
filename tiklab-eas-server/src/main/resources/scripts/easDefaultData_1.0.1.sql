...
INSERT INTO `mec_message_template` (`id`, `name`, `msg_type_id`, `msg_send_type_id`, `title`, `content_config_type`, `content`, `content_url`, `link`) VALUES ('5ea6acf0883ead208d8e75f031ca93df', '事项变更通知', '8066e0357e4bb181b2f7bc438c36dc29', '942591eeee4a3100f2ea2cb871539c65', '事项变更', 1, '有新的消息！', NULL, '/index/message/{id}');
...
-- test on 消息
INSERT INTO `mec_message_type` VALUES ('2ba9b35136183577a6973fbf900d5b4b', '创建仓库通知', NULL);
INSERT INTO `mec_message_template` VALUES ('5ea6acf0883ead208d8e75f031ca94df', '仓库创建通知模板', '2ba9b35136183577a6973fbf900d5b4b', '942591eeee4a3100f2ea2cb871539c65', '空间创建通知', 1, '你创建了一个仓库！', NULL, '/repositorypage/detail');
